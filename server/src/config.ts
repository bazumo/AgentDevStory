...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): AppConfig {
  ...
  return {
    ...
    targetRepo: clean(mergedEnv.AGENTDEVSTORY_TARGET_REPO),
    workspaceRoot: path.resolve(clean(mergedEnv.AGENTDEVSTORY_WORKSPACE_ROOT) ?? path.join(rootDir, ".agentdevstory", "workspaces")),
